...
# Kullanıcının ses kaydını başlatıp durdurabileceği bir buton ekleyin
if st.button('Ses Kaydını Başlat/Durdur'):
    # Ses kaydı bileşeni
    audio_data = st_audiorec()

    # Kaydedilen ses dosyasıyla işlem yapın
    if audio_data:
        # Örneğin, ses dosyasını sunucuya kaydedin
